...
bool createEdge(string startId, string endId, E weight); // Creates a new edge in the graph with some data
...
E &operator()(string startId, string endId); // Gets the value of the edge from the start and end vertexes
