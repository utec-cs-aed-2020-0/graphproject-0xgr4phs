/* 
    ____     ___  _      _      ___ ___   ____  ____       _____   ___   ____   ___   
    |    \   /  _]| |    | |    |   |   | /    ||    \     |     | /   \ |    \ |   \  
    |  o  ) /  [_ | |    | |    | _   _ ||  o  ||  _  |    |   __||     ||  D  )|    \ 
    |     ||    _]| |___ | |___ |  \_/  ||     ||  |  |    |  |_  |  O  ||    / |  D  |
    |  O  ||   [_ |     ||     ||   |   ||  _  ||  |  |    |   _] |     ||    \ |     |
    |     ||     ||     ||     ||   |   ||  |  ||  |  |    |  |   |     ||  .  \|     |
    |_____||_____||_____||_____||___|___||__|__||__|__|    |__|    \___/ |__|\_||_____|
...
DirectedGraph<TV, TE> bellman_ford(DirectedGraph<TV, TE> grafo, const string &nodoInicio)
{
    ...
    {
        if (vertice.first == nodoInicio)
            distanciaPadre[vertice.first] = {{0, 0}, string()};
        else
            distanciaPadre[vertice.first] = {{INT_MAX, 0}, string()};
